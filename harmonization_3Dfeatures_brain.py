...
if __name__ == "__main__":
    ...
    nyul_normalized_dir = f"../datasets/Craig_scans/T1_nifti_nyul_normalized"
    kde_normalized_dir = f"../datasets/Craig_scans/T1_nifti_kde_normalized"
    standard_histogram_path = "../datasets/Craig_scans/standard_histogram/standard_histogram.npy"
    original_features_dir = f"../datasets/Craig_scans/T1_nifti_original_features"
    nyul_normalized_features_dir = f"../datasets/Craig_scans/T1_nifti_nyul_normalized_features"
    kde_normalized_features_dir = f"../datasets/Craig_scans/T1_nifti_kde_normalized_features"
    ...
    #                                     seg_dir=fullbrain_mask_dir,
    #                                     train_files=train_files,
    #                                     standard_histogram_path=standard_histogram_path)
    # apply_nyul_normalization(input_dir, fullbrain_mask_dir, nyul_normalized_dir,
    #                          standard_histogram_path, percentile_step=1.0)
   

    # apply_kde_normalization(input_dir, fullbrain_mask_dir, kde_normalized_dir)
